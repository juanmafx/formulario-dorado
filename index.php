...
$direccion_envio= 'correro-electronico' ; //la direccion a la que se enviara el email.
...
//armamos el html
$contenido = '<html><body>';
$contenido .= '<h2>Mensaje desde Área Contacto</h2>';
...
Nombre*:<br>
<input class="formi" <? if (isset ($flag) && $_POST['nombre']=='') { echo 'class="error"';} else {echo 'class="campo"';}?>  type="text" name="nombre" value="<? echo $_POST['nombre'];?>" >
<br>
Teléfono*:<br>
<input class="formi" <? if (isset ($flag) && $_POST['telefono']=='') { echo 'class="error"';} else {echo 'class="campo"';} ?>  type="text" name="telefono" value="<? echo $_POST['telefono'];?>" >
<br>
Correo electrónico*:<br>
<input  class="formi" pattern="^[a-zA-Z0-9.!#$%'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"  required  <? if (isset ($flag) && $_POST['email']=='') { echo 'class="error"';} else {echo 'class="campo"';} ?>  type="text" name="email" value="<? echo $_POST['email'];?>" >
<br>
Mensaje:<br>
<textarea  class="formi" <? if (isset ($flag) && $_POST['mensaje']=='') { echo 'class="com-error"';} else {echo 'class="campo"';} ?>  name="mensaje"><? echo $_POST['mensaje'];?></textarea>
<br>
<br>
